...
subplot(4,1,2)
bar(A,'FaceColor',[.6 .6 .6],'EdgeColor','k')
axis([0 1024 -0.002 0.002]), axis off
figure(2)
subplot(2,2,1)
A2=flipud(reshape(A,32,32)); pcolor(A2), colormap(gray), axis off
acc1 = sum(test_labels == real)/numel(test_labels);
...
subplot(4,1,4)
bar(A,'FaceColor',[.6 .6 .6],'EdgeColor','k')
axis([0 1024 -0.008 0.008]), axis off
figure(2)
subplot(2,2,2)
A2=flipud(reshape(A,32,32)); pcolor(A2), colormap(gray), axis off
acc2 = sum(test_labels == real)/numel(test_labels);
